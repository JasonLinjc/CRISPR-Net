...
def circle_seq_logv_indels_roc():
    import glob
    import re
    import os
    import encode_data
    ...
    plt.plot(mean_fpr, mean_tpr, color='b',
             ...
             lw=2, alpha=.8)
    # pkl.dump([mean_fpr, mean_tpr, mean_auc, std_auc], open("./results/circle_cnn_lstm_indels_roc.pkl", "wb"))
    ...
    plt.tight_layout()
    # plt.savefig("./circle_cnn_lstm_indels_roc.pdf", format="pdf")
    plt.show()

circle_seq_logv_indels_roc()